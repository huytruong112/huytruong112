...
function render_service_row($service, $qrCodeWebDir, $qrCodeDir, $vlessByService, $csrf_token) {
    ...
    <tr>
      ...
      <!-- Public Key WireGuard với nút Kết Nối Ngay (MỚI) -->
      ...
      <td>
        ...
        <?php elseif ($service['is_activated'] && !empty($service_copy['public_key']) && $status !== "Đã hủy"): ?>
            ...
            <div class="wg-action-buttons">
              ...
              <button class="copy-btn" onclick="copyBlock('pk<?= (int)$service['id'] ?>')">

                <i class="fa fa-copy"></i> Sao chép

              </button>

              <a class="copy-btn" href="download_public_key.php?service_id=<?= (int)$service['id'] ?>">

                <i class="fa fa-download"></i> Tải xuống

              </a>

              <a class="btn-connect-wg" href="wireguard_connect.php?id=<?= (int)$service['id'] ?>">
...
<head>
  ...
  <style>
    ...
    /* Style cho nút Kết nối WireGuard */
    ...
    .btn-connect-wg:hover {

      transform: translateY(-2px);

      box-shadow: 0 6px 16px rgba(136, 211, 206, 0.5);
